 ...
 * last scraped ({@code null} until it has been), whether that count is a floor because the Career
 * Site hit Workday's cap, and why the latest run failed ({@code null} unless it did).
 */
